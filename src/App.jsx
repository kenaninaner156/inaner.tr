...
function App() {
  ...
  const menuItems = [
    ...
    { id: 'map', label: 'Harita', badge_beta: true, icon: <MapPin size={20} />, theme: 'from-indigo-400/80 to-indigo-600/80 shadow-[0_2px_12px_rgba(99,102,241,0.3)] border-indigo-400/30', hoverText: 'group-hover:text-indigo-400' },
