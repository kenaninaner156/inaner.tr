...
function MobileSavedRoutesCard({
  ...
  return (
    <div
      ref={cardRef}
      className="absolute bottom-3 left-3 right-3 z-[1500] pointer-events-auto rounded-[24px] p-3 flex flex-col gap-2.5 shadow-[0_20px_60px_rgba(0,0,0,0.9)] border border-white/10 backdrop-blur-3xl md:hidden overflow-hidden transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]"
      style={{
...
export default function SavedRoutes({ isVisible }) {
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {isVisible && showSidebar && (
          <motion.div
            ...
            initial={{ x: -15, opacity: 0, scale: 0.99, filter: 'blur(6px)' }}
      ...
      {confirmDeleteId && (
        <div
          className="fixed inset-0 z-[4000] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md"
